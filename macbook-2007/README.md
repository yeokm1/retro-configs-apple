...
This Macbook was released in mid 2007. This black version is relatively uncommon and cost more then.

<img src="images/mb07-system.jpg" width="500">

This machine can support up to Mac OS X 10.7 Lion however I opted to go with the older 10.6 Snow Leopard as it has the Rosetta emulator.
...
I got the 10.6.3 ISO from the page on [Archive.org Snow Leopard](https://archive.org/details/691-6634-A2ZMac_OS_Snow_Leopard._Install_DVD._v10.6.3_DVD_DL) page. It's not the latest but the OS can be updated later after installation.

## DMG image only

If the DMG image is used, these steps are followed. Otherwise, just use boot from the ISO image from a DVD or DVD emulator.

<img src="images/mb07-scan-sl-dvd.png" width="500">
...
<img src="images/mb07-flash-sl-dvd.png" width="500">
...
<img src="images/mb07-disk-utility.jpg" width="500">

Go to Disk Utility to create a partition for the entire disk.

<img src="images/mb07-sl-disk-selection.jpg" width="500">

Select that partition to install to.

<img src="images/mb07-sl-customise.jpg" width="500">

I opted to customise the installation to add other optional components.

<img src="images/mb07-sl-bootup.jpg" width="500">
...
* [Powerfox](https://powerfox.jazzzny.me/): Modern browser for Snow Leopard

### Preparing to install Windows 10 32 bit

(This section is kept for reference as I have since not installed Win 10 on this machine.)
...
<img src="images/mb07-bootcamp.png" width="500">
...
<img src="images/mb07-slave-install.jpg" width="500">
...
<img src="images/mb07-disk-name.png" width="500">
...
<img src="images/mb07-vbox-system-setup.png" width="700">

Configure the system parameters to use Windows 10 32 bit.

<img src="images/mb07-vbox-cd.png" width="500">

Add an IDE drive loaded with Windows 10 ISO.

<img src="images/mb07-vbox-hdd.png" width="700">
...
<img src="images/mb07-win-install-boot.png" width="500">

Since this is a VM and the disk access has to go through a relatively slow FW400 cable, it will take a while to load.

<img src="images/mb07-win-install-format.png" width="500">

Format the Bootcamp partition with NTFS.

<img src="images/mb07-win-install-installing.png" width="500">
...
<img src="images/mb07-win-install-restart.png" width="500">
...
<img src="images/mb07-refind.jpg" width="500">
...
<img src="images/mb07-windows-installed.jpg" width="500">
